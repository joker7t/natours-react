...
import Video4 from './img/video.mp4';
import VideoWeb from './img/video.webm';
import LogoGreenSmall1x from './img/logo-green-1x.png';
import LogoGreenSmall2x from './img/logo-green-2x.png';
            ...
            <div className="col-1-of-2">
              <div className="composition">
                ...
                <img srcSet={`${Nat1} 300w, ${Nat1Large} 1000w`}
                  ...
                  className="composition__photo composition__photo--p1" src={Nat1Large} />

                <img srcSet={`${Nat2} 300w, ${Nat2Large} 1000w`}
                  sizes="(max-width: 56.25em) 20vw, (max-width: 37.5em) 30vw, 300px" alt=""
                  className="composition__photo composition__photo--p2" src={Nat2Large} />

                <img srcSet={`${Nat3} 300w, ${Nat3Large} 1000w`}
                  sizes="(max-width: 56.25em) 20vw, (max-width: 37.5em) 30vw, 300px" alt=""
                  className="composition__photo composition__photo--p3" src={Nat3Large} />
